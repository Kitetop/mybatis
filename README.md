...
## Notice
````
All the the core code of the design is located in：[src/main/java/com.xieshizhen](https://github.com/Kitetop/mybatis/tree/master/src/main/java/com/xieshizhen)
